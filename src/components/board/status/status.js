...
export default function FixedContainer() {
  ...
  React.useEffect( () => {
    axios.get('/api/selectAllBodyCountByQuarter', {params: { quarter : '2021년도 1분기' }})
    .then(({data}) => {
      console.log("data======" + JSON.stringify(data[0][0]) + data[0][0].COUNT)
      ...
      <Container fixed >
        <Box sx={{ bgcolor: 'none', height: '100vh' }} sx={{ mt: 6 }} >
            <Card variant="outlined">
              ...
              >
                <Badge badgeContent={data} color="primary" sx={{ml: -1, fontFamily:'Nanum Gothic'}}>
